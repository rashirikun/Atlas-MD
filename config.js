...
/                                                                                   / 
/-----------------------------------------------------------------------------------/
/ Author and Main Developer: julin                                                 /
/ Github: https://github.com/rahirikun/Atlas-MD                                     /
/ Powered By: Team Bwa kale                                                            /
/-----------------------------------------------------------------------------------/
/             Meet Team julin who holds all rights to this repository:              /
/                                                                                   /
...
if (!gg) {
  gg = "19543145805";   // You can Change this number //
}

// -------------------------------------------------------------- //


global.owner = gg.split("19543145805");
...
global.packname = process.env.PACKNAME || `julin4real MD`;
